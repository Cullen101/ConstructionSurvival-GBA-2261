...
# 1 "pauseScreen.h" 1
# 22 "pauseScreen.h"
extern const unsigned short pauseScreenTiles[2624];
...
void goToStart() {
    ...
    DMANow(3, menuScreenTiles, &((charblock *)0x6000000)[0], 13888 / 2);
    DMANow(3, menuScreenMap, &((screenblock *)0x6000000)[28], 2048 / 2);
    DMANow(3, fixScreenTiles, &((charblock *)0x6000000)[1], 32 / 2);
    DMANow(3, fixScreenMap, &((screenblock *)0x6000000)[24], 2048 / 2);
    stopSound();
    state = START;
}
...
void goToInstructions() {
    ...
    DMANow(3, instructionScreenTiles, &((charblock *)0x6000000)[0], 13248 / 2);
...
void goToGame() {
    DMANow(3, testScreenPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, testScreenTiles, &((charblock *)0x6000000)[1], 5216 / 2);
    DMANow(3, testScreenMap, &((screenblock *)0x6000000)[24], 2048 / 2);
...
void goToPause() {
    ...
    DMANow(3, pauseScreenTiles, &((charblock *)0x6000000)[0], 5248/2);
...
void goToWin() {
    ...
    DMANow(3, winScreenTiles, &((charblock *)0x6000000)[0], 15744/2);
...
void goToLose() {
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 10720/2);
