...
void drawBullet(BULLET *b) {
    if (b->active) {
        shadowOAM[4].attr0 = (0xFF & (b->row - vOff)) | (0 << 13) | (0 << 14);
        shadowOAM[4].attr1 = (0x1FF & (b->col - hOff)) | (0 << 14);


        if (b->rdel > 0) {
            shadowOAM[4].attr2 = ((6)*32 + (12)) | ((0) << 12);

        } else if (b->rdel < 0) {
            shadowOAM[4].attr2 = ((4)*32 + (12)) | ((0) << 12);
            ...
            if (b->direction == 2) {
                ...
                shadowOAM[4].attr2 = ((2)*32 + (14)) | ((0) << 12);


            } else {
                shadowOAM[4].attr2 = ((2)*32 + (12)) | ((0) << 12);
